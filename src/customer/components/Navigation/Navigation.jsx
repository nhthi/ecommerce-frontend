...
import { Bookmark, Logout, PersonAdd, Settings, SpaceDashboard } from '@mui/icons-material'
                      ...
                      <div key={section.name}>
                        ...
                        >
                          {section.items.map((item) => (
                            <li key={item.name} className="flow-root" onClick={() => handleCategoryClick(category, section, item, handleClose)}>
          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <p onClick={() => navigate("/")}>
                  <span className="sr-only">NHTHI Shop</span>
                  <img
                    alt=""
                    src="https://logolook.net/wp-content/uploads/2021/07/Naruto-Logo.png"
                                    ...
                                    >
                                      {section.items.map((item) => (
                                        <li key={item.name} className="flex">
                                          <PopoverButton className="hover:text-gray-800 cursor-pointer" onClick={() => handleCategoryClick(category, section, item, handleClose)}>
                                            {item.name}
                                          </PopoverButton>
                                        </li>
                                      ))}
              ...
              <div className="ml-auto flex items-center">
                    ...
                    <React.Fragment>
                      <Box sx={{ display: 'flex', alignItems: 'center', textAlign: 'center' }}>
                        <Tooltip title="Account settings">
                          ...
                          >
                            <Avatar sx={{ width: 32, height: 32 }}>{auth.user?.firstName[0].toUpperCase()}</Avatar>
                          </IconButton>
                        </Tooltip>
                      </Box>
                      <Menu
                      ...
                      >
                        ...
                        <Divider />
                        {auth.user?.role === 'ROLE_ADMIN' ? <MenuItem onClick={() => navigate('/admin')}>
                          <ListItemIcon>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <p onClick={handleClickCart} className="group -m-2 flex items-center p-2 cursor-pointer">
                    <ShoppingBagIcon
                      aria-hidden="true"
